    ...
    try:
        ...
        if "thematic_lcm_mdd_classifier" in available_archs:
            ...
            if config.num_themes == 9:
                ...
                print(f"❌ Incorrect number of themes: {config.num_themes} (expected 9)")
            ...
            if config.theme_embed_dim == 512:
                ...
                print(f"⚠️  Non-standard theme embedding dimension: {config.theme_embed_dim}")
        ...
        print("   but dependencies like fairseq2 are not available in this environment.")
